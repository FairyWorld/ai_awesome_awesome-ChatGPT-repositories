 ...
 * [squidgy-prompts](https://github.com/squidgyai/squidgy-prompts) - #chatgpt and language learning?we’ve just released an open source set of prompts to help learners build decks, sentence mine, correct grammar, play word games and more. can be used on their own or in @squidgiesapp.
 ...
 * [comfyui_LLM_party](https://github.com/heshengtao/comfyui_llm_party) - RAG.
 ...
 * [slack-gpt](https://github.com/martinseanhunt/slack-gpt) - bot starter that fetches answers to questions using Langchain, OpenAI and a Pincone vectorstore
 ...
 * [org-ai](https://github.com/rksm/org-ai) - output.
 ...
 * [pandas-ai](https://github.com/gventuri/pandas-ai) - 4, Anthropic, VertexAI) and RAG.
 ...
 * [quivr](https://github.com/quivrhq/quivr) - 4 turbo, Private, Anthropic, VertexAI, Ollama, LLMs, that you can share with users !  Local & Private alternative to OpenAI GPTs & ChatGPT powered by retrieval-augmented generation.
 * [smalltalk](https://github.com/tinystruct/smalltalk) - ChatGPT. @tinystruct
 * [maid](https://github.com/mobile-artificial-intelligence/maid) - llama.cpp models locally, and with Ollama and OpenAI models remotely.
 * [pandas-ai](https://github.com/sinaptik-ai/pandas-ai) - 4, Anthropic, VertexAI) and RAG.
 ...
 * [nlux](https://github.com/nluxai/nlux) - Javascript Library To Build Conversational AI Interfaces
 ...
 * [LangBot](https://github.com/rockchinq/langbot) - Agent 平台
 ...
 * [Hexabot](https://github.com/hexastack/hexabot) - agents with ease.
 ...
 * [LangBot](https://github.com/langbot-app/langbot) - Slack 🧩 Integrated with ChatGPT、DeepSeek、Dify、n8n、Claude、Google Gemini、xAI、PPIO、Ollama、阿里云百炼、SiliconFlow、Qwen、Moonshot、SillyTraven、MCP、WeClone etc. LLM & Agent
 ...
 * [Chatterbox-TTS-Server](https://github.com/devnen/chatterbox-tts-server) - Self-host the powerful Chatterbox TTS model. This server offers a user-friendly Web UI, flexible API endpoints (incl. OpenAI compatible), predefined voices, voice cloning, and large audiobook-scale text processing. Runs accelerated on NVIDIA (CUDA), AMD (ROCm), and CPU.
 ...
 * [openagent](https://github.com/the-open-agent/openagent) - Next-generation personal AI assistant powered by LLM, RAG and agent loops. Supporting computer-use, browser-use and coding agent with 30+ model providers, MCP-compatible tools, visual workflow builder and admin dashboard. Demo: https://demo.openagentai.org
 ...
 * [ethgpt](https://github.com/xinbenlv/ethgpt) - smart contract functionalities
 * [GodMode](https://github.com/smol-ai/godmode) - Llama2! I use this 20 times a day.
 ...
 * [CoDeveloperGPTengine](https://github.com/stoerr/codevelopergptengine) - writing files, executing (build) actions
 ...
 * [bob-plugin-openai-polisher](https://github.com/openai-translator/bob-plugin-openai-polisher) - 使用 OpenAI API 给文本进行润色和语法纠错的 Bob 插件！完美代替 Grammarly！Licensed under CC BY-NC-SA 4.0
 ...
 * [json-translator](https://github.com/mololab/json-translator) - Argos
 ...
 * [pocketpaw](https://github.com/pocketpaw/pocketpaw) - Your AI agent in 30 seconds. Not 30 hours. Self-hosted, open-source personal AI with desktop installer, multi-agent Command Center(Deep Work), and 7-layer security. Anthropic, OpenAI, or Ollama.
 ...
 * [chinese-llm-benchmark](https://github.com/jeinlee1991/chinese-llm-benchmark) - chatglm6b 等开源大模型，多维度能力评测。不仅提供能力评分排行榜，也提供所有模型的原始输出结果！
 ...
 * [searchGPT](https://github.com/michaelthwan/searchgpt) - OpenAI API. It supports web search, file content search etc.
 ...
 * [OpenAdapt](https://github.com/openadaptai/openadapt) - Visual Language (VLMs)) Models
 ...
 * [AIaW](https://github.com/nitrorcr/aiaw) - AI as Workspace - 精心设计的 AI (LLM) 客户端。 全功能，轻量级；支持多工作区、插件系统、跨平台、本地优先+实时云同步、Artifacts
 ...
 * [auto-novel](https://github.com/auto-novel/auto-novel) - 轻小说机翻网站，支持网络小说/文库小说/本地小说
 ...
 * [dyad](https://github.com/dyad-sh/dyad) - Bolt alternative 🌟 Star if you like it!
 ...
 * [IIMS-By-AI](https://github.com/aitenry/iims-by-ai) - AI-Powered Intelligent Information Management Platform
 * [cascadeflow](https://github.com/lemony-ai/cascadeflow) - Smart AI model cascading for cost optimization
 ...
 * [langchat](https://github.com/tycoding/langchat) - Claude 等大模型), Java生态下AI大模型产品解决方案，快速构建企业级AI知识库、AI机器人应用
 ...
 * [kubewall](https://github.com/kubewall/kubewall) - LMStudio)
 ...
 * [casdoor](https://github.com/casdoor/casdoor) - Single-Sign-On (SSO) platform powered by Casbin and AI gateway with web UI supporting OAuth 2.0, OIDC, SAML and OpenAI ChatGPT
 ...
 * [NeuroGPT](https://github.com/neurogen-dev/neurogpt) - ChatGPT API
 ...
 * [gpt-tokenizer](https://github.com/niieani/gpt-tokenizer) - GPT-4. Port of OpenAI's tiktoken with additional features.
 ...
 * [ShortGPT](https://github.com/rayventura/shortgpt) - tiktok channel automation
 ...
 * [Mysti](https://github.com/deepmyst/mysti) - AI coding dream team of agents for VS Code. Claude Code + openai Codex collaborate in brainstorm mode, debate solutions, and synthesize the best approach for your code.
 ...
 * [flutter_chatgpt_api](https://github.com/coskuncay/flutter_chatgpt_api) - Dart
 ...
 * [spring-chatgpt-sample](https://github.com/azure-samples/spring-chatgpt-sample) - Java Stack
 ...
 * [ChatGPT-Virtual-Live](https://github.com/smallnew666/chatgpt-virtual-live) - ChatGPT虚拟主播、支持B站、抖音、视频号
 ...
 * [OpenGPT-Business](https://github.com/black-fruit/opengpt-business) - chatgpt商业应用！79E/ChatGpt-Web 的1.3.9最新！本人破解，无需授权！
 ...
 * [NeuroGPT](https://github.com/em1tsan/neurogpt) - ChatGPT 4
 ...
 * [ChatGPT-Next-Web](https://github.com/chatgptnextwebteam/chatgpt-next-web) - MacOS). 一键拥有你自己的跨平台 ChatGPT 应用。
 ...
 * [ChatGPT-Next-Web](https://github.com/chatgptnextweb/chatgpt-next-web) - MacOS). 一键拥有你自己的跨平台 ChatGPT 应用。
 ...
 * [ai-to-pptx](https://github.com/chatbookai/ai-to-pptx) - Ai-to-pptx是一个使用AI技术(ChatGpt和Gemini)制作PPTX的助手，支持在线修改和导出PPTX。 主要功能: 1 使用ChatGPT等大语言模型来生成大纲 2 生成的内容允许用户再次修改 3 生成PPTX的时候可以选择不同的模板 4 支持在线修改PPTX的文字内容，样式，图片等 5 支持导出PPTX，PDF，PNG等多种格式
 ...
 * [airport-access](https://github.com/chatgpt-helper-tech/airport-access) - Netflix，含使用教程。
